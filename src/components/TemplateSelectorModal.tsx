      ...
      <dialog id="template_modal" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box max-w-4xl bg-base-100 p-6 rounded-2xl shadow-2xl border border-base-300">
          ...
          <div className="tabs tabs-boxed my-4 bg-base-200 p-1">
            <button
              className={`tab flex-1 font-semibold ${activeTab === "analog" ? "tab-active bg-base-100 shadow" : ""
                }`}
            ...
            <button
              className={`tab flex-1 font-semibold ${activeTab === "digital" ? "tab-active bg-base-100 shadow" : ""
                }`}
              ...
              ? ANALOG_TEMPLATES.map((tmpl) => {
                ...
                return (
                  <div
                    ...
                    className={`card cursor-pointer border-2 transition-all duration-200 hover:scale-[1.02] p-4 flex flex-col justify-between ${isSelected
